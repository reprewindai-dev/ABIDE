...
${emailToUse}`;
    ...
    if (selectedProvider === "veklom") {
      ...
      // Build payload
      const payload: any = {
        model: modelName || (selectedProvider === "deepseek" ? "deepseek-chat" : selectedProvider === "openai" ? (openAiBaseUrl.includes("11434") || openAiBaseUrl.includes("167.233.202.195") ? "llama3.2:latest" : "gpt-4o") : "llama3.2:latest"),
        messages: [
...
${JSON.stringify(blueprint, null, 2)}`;
  ...
  try {
    ...
    if (selectedProvider === "gemini") {
      ...
      const model = modelName || (selectedProvider === "deepseek" ? "deepseek-chat" : selectedProvider === "openai" ? (openAiBaseUrl && (openAiBaseUrl.includes("11434") || openAiBaseUrl.includes("167.233.202.195")) ? "llama3.2:latest" : "gpt-4o") : (selectedProvider === "llama" || selectedProvider === "ollama") ? "llama3.2:latest" : "llama3.2:latest");
